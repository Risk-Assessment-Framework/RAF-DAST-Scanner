...
The repository has the following folder structure:
  ...
  -vulnerability.py - Contains the implementation of various vulnerability scanners.
  -server.py - Contains the implementation of the server to receive and store scan reports.
  -test.py - Contains test cases for the REST API.
